...
try {
  window.paper = __webpack_require__(/*! paper/dist/paper-full */ "./node_modules/paper/dist/paper-full.js");
} catch (e) {}
  ...
  function initCanv() {
    ...
    var raster = new Raster({
      ...
      onLoad: function onLoad() {
        ...
        // this.scale(0.25);
        this.position = view.center; // create a clipping rectangle based on raster bounds

        var clippingRectangle = new Path.Rectangle(raster.bounds); // create a clipping group with a clipping rectangle as first child

        var group = new Group(path, raster, clippingRectangle);
        group.clipped = true; // rasterize layer

        var rasterized = project.activeLayer.rasterize(); // show rasterized layer bounds

        rasterized.selected = true; // place rasterized layer at the right of original drawing
...
__webpack_require__(/*! /Users/lestertan/projects/paperjs-lasso-cropper/paperjs-lasso-cropper/src/js/app.js */"./src/js/app.js");
module.exports = __webpack_require__(/*! /Users/lestertan/projects/paperjs-lasso-cropper/paperjs-lasso-cropper/src/scss/app.scss */"./src/scss/app.scss");
